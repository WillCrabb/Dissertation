...
namespace PrototypeLayoutTesting
{
    class ViewModel : DependencyObject
    {
        ...
        /// <summary>
        /// Opens a file dialog and passes the chosen file to the model for extraction
        /// </summary>
        public void OpenFileDialog()
        {
            ...
            if (dialog.ShowDialog().Value)
            {
                ...
                {
                    m_model.ExtractSvgData(dialog.FileName);
                }
        ...
        /// <summary>
        /// Converts all of the paths in the SVG to paths which can be displayed on the form
        /// </summary>
